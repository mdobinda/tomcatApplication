...
@WebServlet(value = "/rootServletSession")
public class rootServletSession extends HttpServlet {
        ...
        try
        {
            ...
            if (query.charAt(0) == 'i' || query.charAt(0) == 'I')
            {
                try
                {
                    ...
                    if (query.contains("shipments"))
                    {
                        ...
                        table.append("<tr><td id='succ'><center>Business Logic Detected! - Updating Supplier Status<br> Business Logic ipdated " + success + " supplier status marks.</center></td></tr>");
            ...
            else if (query.charAt(0) == 'u' || query.charAt(0) == 'U')
            {
                ...
                if (query.contains("shipments"))
                {
                    ...
                    table.append("<tr><td id='succ'><center>Business Logic Detected! - Updating Supplier Status<br>Business Logic updated " + success + " supplier status marks.</center></td></tr>");
                    dbString = table.toString();
