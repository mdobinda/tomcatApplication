...
<head>
  ...
  <style type="text/css">
    <!--
    body { background-color: #ede4e0; color: #665a48; font-family: verdana, arial, sans-serif; font-size: 1.4em;  }
    input[type="submit"] {background-color: yellow; font-weight:bold;}
    textarea {background-color: #c8dbbe; color: #9f8772; font-size:20px; border-radius: 2%; border-color: #abc29f; border-width: medium;}
    span {color:white;}
    #name {color:white; font-size:25px;}
    #welcome {color: #665a48; font-size:30px;}
    #subtitle {color: #9f8772; font-size:25px;}
    #title {color: #000000; font-size:15px;}
    #user {color: limegreen; font-size:15px;}
    #default {color:green; font-size:10px;}
    button {background-color: #c8dbbe; color: #665a48;
    ...
    #error {background-color: #eb6440; color:white; padding: 5px 5px; font-size:17px;}
...
<body>
<center>
  <form action="/TestingProject2Pt3_war_exploded/clientServletSession" method="get">
    ...
    <label id="title">
      You are connected to the database as a <label id="user"> client-level </label> user.
      <br>
